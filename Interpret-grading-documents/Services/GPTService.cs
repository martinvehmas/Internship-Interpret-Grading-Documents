...
namespace Interpret_grading_documents.Services
{
    public class GPTService
    {
        ...
        public class GraduationDocument
        {
            ...
            [JsonPropertyName("personal_id")] public string PersonalId { get; set; }
        ...
        {
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "SampleImages",
                "SlutBetyg_02.png");
                ...
                [
                    new UserChatMessage(
                        ChatMessageContentPart.CreateTextPart(
                            "Vänligen extrahera följande data från bilden, svara endast med JSON, formatera det inte med ` eller liknande. Säkerställ att alla betygen är korrekta och överenstämmer med deras ämne."),
                        ChatMessageContentPart.CreateTextPart(
                            "1. Fullständigt namn\n" +
                            "2. Personnummer\n" +
                            "3. Examensdatum\n" +
