...
namespace Interpret_grading_documents.Services
{
    ...
    public class ImageReliabilityChecker
    {
        ...
        public static List<Mat> SegmentImageWithTableDetection(string imagePath, string outputDirectory)
        {
            ...
            int horizontalSize = horizontal.Cols / 20; // Increased for better horizontal line detection
            ...
            int verticalSize = vertical.Rows / 20; // Increased for better vertical line detection
            ...
            foreach (var contour in contours)
            {
                ...
                if (boundingRect.Width > 50 && boundingRect.Height > 50) // Adjusted size based on document characteristics
                {
